    ...
    'productGridItemHtml': '<div class="col-lg-3 col-6 index-f-products__col">' +
								'<div class="product-item">'+
									...
									'<div class="product-item__title-bar">'+
										...
										'{{itemTitle}}</a>'+
										'<button class="swym-button swym-add-to-wishlist-view-product product_{{itemId}} swym-iconbtnlink swym-heart swym-loaded" data-swaction="addToWishlist" data-product-id="{{itemId}}" aria-label="Add to Favorites"></button>'+
									'</div>'+
